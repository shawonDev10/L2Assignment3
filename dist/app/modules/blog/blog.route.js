...
route.post("/", (0, auth_1.default)(user_interface_1.ROLE.admin, user_interface_1.ROLE.user), (0, validateSchema_1.default)(blog_validation_1.BlogValidateSchema), blog_controller_1.blogControllers.createBlog);
...
route.delete("/:id", (0, auth_1.default)(user_interface_1.ROLE.admin, user_interface_1.ROLE.user), blog_controller_1.blogControllers.deleteBlog);
